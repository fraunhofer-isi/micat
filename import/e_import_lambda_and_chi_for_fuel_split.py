...
def main():
    ...
    missing_entries = database_import.validate_table(chi)
...
def calculate_chi_industry(import_folder, final_energy_carrier_ids):
    ...
    index_columns = ['id_region', 'id_subsector', 'id_action_type', 'id_final_energy_carrier']
...
def translate_regional_sheets(sheets, id_region_table):
    ...
    for sheet_name, raw_sheet in sheets.items():
        ...
        sheet = sheet[['id_region', 'id_subsector', 'id_action_type', 'id_final_energy_carrier', 'chi']]
