...
module.exports = {
  ...
  // collectCoverage: true,   // done by command line switch
  ...
  // Also see https://stackoverflow.com/questions/69226759/jest-unexpected-token-export-when-using-d3
  moduleNameMapper: {
    '\\.(css|scss)$': 'identity-obj-proxy',
    '^xlsx$': '<rootDir>/node_modules/xlsx/dist/xlsx.full.min.js',
    '^tabulator-tables$': '<rootDir>/node_modules/tabulator-tables/dist/js/tabulator.min.js',
