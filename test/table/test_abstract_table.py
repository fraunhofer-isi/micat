...
import pandas as pd
from test_utils.assertion import falsy, truthy
from test_utils.mock import Mock, fixture, patch, raises

from log.logger import Logger
from table.abstract_table import AbstractTable
...
class TestPublicApi:
    ...
    def test_iterrows(self, sut):
        from series.annual_series import (  # pylint: disable=import-outside-toplevel
            AnnualSeries,
        )
...
class TestPrivateApi:
    ...
    class TestOtherValue:
        ...
        def test_abstract_series(self):
            from series.abstract_series import (  # pylint: disable=import-outside-toplevel
                AbstractSeries,
            )
