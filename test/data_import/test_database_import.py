...
from table.mapping_table import MappingTable
...
class TestPublicApi:
    ...
    class TestExcecuteImportScriptsInFolder:
        ...
        def test_with_excluded_scripts(self):
            disable_stdout()
            DatabaseImport.execute_import_scripts_in_folder('mocked_cwd', ['mocked_file_a.py'])
            enable_stdout()
...
class TestPrivateApi:
    ...
    def test_recreate_data_table(self, sut):
        ...
        mocked_table = Mock()
        mocked_table.column_names = (['mocked_id_column'], ['mocked_year_column'], ['mocked_value_column'])
