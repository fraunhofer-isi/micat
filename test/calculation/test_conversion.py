...
from calculation.conversion import primary_energy_saving, total_primary_energy_saving
...
def test_primary_energy_saving():
    ...
    final_energy_savings_by_action_type = Table(
        [
            {'id_subsector': 1, 'id_action_type': 1, 'id_final_energy_carrier': 1, '2020': 5, '2030': 10},
