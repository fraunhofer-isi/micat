...
import calculation
from calculation.social import dwelling, energy_poverty_national
...
@patch(
    calculation.social.lifetime.measure_specific_lifetime,
    'mocked_lifetime',
)
@patch(
...
@patch(
    calculation.economic.investment.investment_cost_in_euro,
    Table([{'id_measure': 1, '2000': 1}]),
)
@patch(
...
class TestEnergyPovertyGap:
    ...
    def test_mode_m2(self):
        with patch(
            calculation.extrapolation.extrapolate,
...
@patch(
    calculation.extrapolation.extrapolate_series,
    'mocked_result',
)
