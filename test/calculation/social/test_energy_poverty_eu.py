...
class TestPopulationTable:
    ...
    def test_id_mode_3(self):
        result = energy_poverty_eu._population_table(
            _mocked_final_energy_savings_by_action_type(), self.mocked_data_source, 3
        )
        assert result['2030'][2] == 2.0

    def test_id_mode_not_3(self):
        result = energy_poverty_eu._population_table(
            _mocked_final_energy_savings_by_action_type(), self.mocked_data_source, 1
        )
        assert result['2030'][2] == 2.0
