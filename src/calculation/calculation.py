...
from calculation import air_pollution, conversion, cost_benefit_analysis
from calculation.ecologic import calculation_ecologic, energy_saving
from calculation.economic import calculation_economic, energy_cost, eurostat, population
