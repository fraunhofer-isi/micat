...
*This table is from back_end/import/raw data/id_region.xlsx*
...
*This table is from back_end/import/raw data/id_sector.xlsx*
...
*This table is from back_end/import/raw data/id_subsector.xlsx*

*A mapping of subsectors to main sectors can be found in*
*back_end/import/raw data/mapping__subsector__sector.xlsx*
...
*This table is from back_end/import/raw data/id_action_type.xlsx*

*A mapping of improvement actions to subsectors can be found in*
*back_end/import/raw data/mapping__subsector__action_type.xlsx*
...
*This table is from back_end/import/raw data/id_final_energy_carriers.xlsx*
...
*This table is from back_end/import/raw data/id_primary_energy_carriers.xlsx*
...
the subdivision of graphs in the front end.<details>

Details about the mapping of indicators to social, economic, and ecologic indicator groups can be found in
*back_end/import/raw data/mapping__final_energy_carrier__primary_energy_carrier.xlsx*
...
*The id_parameter table can be found here: back_end/import/raw data/id_parameter.xlsx*
